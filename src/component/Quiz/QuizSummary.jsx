        ...
        if (state !== undefined) {
            stats = (
                <Fragment>
                    ...
                    <Link to="/QuizCategories" ><MDBBtn  color="white">Take a Quiz</MDBBtn></Link>
                    <Link to="/" ><MDBBtn outline color="white">Back to Home</MDBBtn></Link>
            ...
            stats = (
              <Fragment>
                    ...
                    <hr className="hr-light" style={{ margin : 32}}/>
